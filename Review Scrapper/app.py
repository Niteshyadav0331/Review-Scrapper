...
@app.route('/scrap', methods=['POST']) # route with allowed methods as POST
def index():
    if request.method == 'POST':
        searchString = request.form['content'].replace(" ","%20") # obtaining the search string entered in the form
        try:
            ...
            for commentbox in commentboxes:
                ...
                mydict = {"Product": searchString.replace("%20", ""), "Name": name, "Rating": rating, "CommentHead": commentHead,
